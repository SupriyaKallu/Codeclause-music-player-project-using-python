...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/aadvi/Downloads/new music","")
...
def Play():
    ...
    song=f'C:/Users/aadvi/Downloads/new music{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/aadvi/Downloads/new music{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/aadvi/Downloads/new music{temp}'
...
root=Tk()
root.title(' Codeclause Music player App ')
#initialize mixer 
mixer.init()
...
#play button
play_button=Button(root,text="►",width =7,command=Play)
